...
const Footer = () => {
  return (
    <section
      className={`flex justify-center items-center sm:py-10 py-3 flex-col bg-black font-Neucha animate-slide-up opacity-0 transform translate-neg-y-full`}
    >
      <div
        ...
        <div className="flex-[1] flex flex-col justify-start mr-10 sm:items-center sm:min-w-[90%] md:min-w-0">
          ...
          />
          <p
            className={`font-normal text-dimWhite text-center text-[40px] leading-[38px] font-Neucha mt-4 max-w-[312px]`}
          >
            ...
            >
              ...
              <ul className="list-none mt-4">
                {footerlink.links.map((link, index) => (
                  <li
                    key={link.name}
                    className={`font-normal text-[30px] leading-[40px] text-dimWhite hover:text-secondary cursor-pointer ${
