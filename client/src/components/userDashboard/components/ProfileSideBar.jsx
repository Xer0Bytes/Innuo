...
const ProfileSideBar = () => {
  ...
  return (
    <div
      className={` ${currentUser.isContributer?"bg-[#FFC6CD]": "bg-[#CEE69A]"}  min-w-[300px] min-h-full fixed top-0 right-0 p-3 hidden lg:block`}
    >
      ...
      <div className="w-full px-4 lg:order-2 flex justify-center">
        <img
          ...
          className="shadow-3xl bg-white mt-6 rounded-full max-w-[150px] w-[150px] h-[150px] align-middle border-none max-w-[150px]"
        />
      </div>
