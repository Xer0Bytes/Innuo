...
const ProfileSideBar = () => {
  return (
    <div
      className="bg-[#B7EDDF] min-w-[280px] min-h-full fixed top-0 right-0 p-2"
    >
      <h3 className="text-center text-5xl font-bold leading-normal pt-2 text-blueGray-700 mb-2">
        Welcome Back!
      </h3>
      ...
      <div className="text-center">
        <h3 className="text-4xl text-semibold leading-normal mt-0 text-blueGray-700 mb-2">
          Jenna Stones
        </h3>

        <div className="items-center justify-center mt-10">
          <div className="text-xl leading-normal mt-0 text-blueGray-400">
