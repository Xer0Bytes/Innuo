  ...
  try {
    ...
    const fieldUpdates = {
      question: {
        ...
        questionImageURL: data.questionImageURL ? data.questionImageURL : null,
        choice1Text: data.choice1Text ? data.choice1Text : null,
        choice1ImageURL: data.choice1ImageURL ? data.choice1ImageURL : null,
        choice2Text: data.choice2Text ? data.choice2Text : null,
        choice2ImageURL: data.choice2ImageURL ? data.choice2ImageURL : null,
        choice3Text: data.choice3Text ? data.choice3Text : null,
        choice3ImageURL: data.choice3ImageURL ? data.choice3ImageURL : null,
        choice4Text: data.choice4Text ? data.choice4Text : null,
        choice4ImageURL: data.choice4ImageURL ? data.choice4ImageURL : null,
