export const verifyEmailFormat = (verificationLink) => {
  return `<!DOCTYPE html>
                                ...
                                <td class="pad" style="padding-bottom:10px;padding-left:40px;padding-right:40px;padding-top:10px;">
                                  <div style="font-family: sans-serif">
                                    <div class style="font-size: 12px; font-family: Montserrat, Trebuchet MS, Lucida Grande, Lucida Sans Unicode, Lucida Sans, Tahoma, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
                                      <p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 21px;">Welcome to Innuo! We are so happy that you are joining our community. Please verify your email by simply clicking the button below to get started today. The link expires in 24 hours.</p>
                                    </div>
                                  </div>
                                </td>
                              </tr>
